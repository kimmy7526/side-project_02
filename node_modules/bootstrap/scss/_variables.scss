...
$primary: #A18E70;  //$blue  !default;
$secondary:#E0C68B; //$gray-600  !default;
$success: $green  !default;
$info: #393E6D; //$cyan  !default;
$warning: $yellow  !default;
$danger: $red  !default;
$light: #DCE3E7; //$gray-100  !default;
$dark: #3A302E; //$gray-900  !default;
...
$body-text-align: center; //null !default;
...
$link-color: $light; //$primary  !default;
...
$border-radius: 0px; //.25rem !default;
...
$font-family-base: 'Comic Sans MS'; //var(--#{$variable-prefix}font-sans-serif) !default;
...
$font-weight-normal:500;// 400 !default;
...
$input-placeholder-color: $gray-500; //$gray-600  !default;
...
$navbar-padding-y: 10px; //$spacer * .5 !default;
$navbar-padding-x: null !default;

$navbar-nav-link-padding-x: 25px; //.5rem !default;
...
$pagination-color:$secondary;// $link-color  !default;
...
$pagination-hover-color: $primary;//$link-hover-color  !default;
...
$card-border-radius: 5px; //$border-radius  !default;
...
$card-height: 450px; //null !default;
...
$modal-content-bg:$light;// $white  !default;
...
$modal-header-border-color: transparent;//$border-color  !default;
